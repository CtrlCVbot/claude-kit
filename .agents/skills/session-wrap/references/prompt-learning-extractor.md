<!-- kit:managed source=src/codex/core/skills/session-wrap/references/prompt-learning-extractor.md hash=4f496045dba7bd567bf1a4833e15651f892c14b6ed5ef12064e8febf6850bdbb -->
  ...
  "items": [
    {
      ...
      "title": "Database RLS 패턴 학습",
      "description": "Row-Level Security 정책을 모든 테이블에 적용하는 패턴을 학습함.",
      "category": "user",
      "priority": "low",
