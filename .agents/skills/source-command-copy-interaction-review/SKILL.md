---
name: "source-command-copy-interaction-review"
description: "interaction state 갭 분석"
---

# source-command-copy-interaction-review

Use this skill when the user asks to run the migrated source command `copy-interaction-review`.
