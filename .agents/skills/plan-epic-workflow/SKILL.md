...
Codex-kit v2.4.0 Hierarchical Plan Structure 의 **Epic** 라이프사이클을 정의한다. Epic 은 Feature 상위 계층으로, 여러 Feature 를 묶어 제품 Theme·cross-cutting 요구사항·명시적 의존성을 관리한다. **Opt-in** 원칙 — Epic 없이도 기존 flat 구조로 작동한다.
