...
description: |
  Codex-kit 컴포넌트 스캐폴딩 엔진. 12개 템플릿(Codex 8 + Codex 4)으로 듀얼 타깃
...
## 템플릿 목록 (12종: Codex 8 + Codex 4)

### Codex 템플릿

| # | 템플릿 | 대상 타입 | 생성 경로 |
|---|--------|----------|-----------|
| 1 | template-skill.md | skill | `src/Codex/{domain}/skills/{full_name}/SKILL.md` |
| 2 | template-agent.md | agent | `src/Codex/{domain}/agents/{full_name}.md` |
| 3 | template-command-simple.md | command (--simple) | `src/Codex/{domain}/commands/{full_name}.md` |
| 4 | template-command-complex.md | command (--complex) | `src/Codex/{domain}/commands/{full_name}.md` |
| 5 | template-hook-pre.md | hook (--pre) | `src/Codex/{domain}/hooks/{full_name}.js` |
| 6 | template-hook-post.md | hook (--post) | `src/Codex/{domain}/hooks/{full_name}.js` |
| 7 | template-hook-stop.md | hook (--stop) | `src/Codex/{domain}/hooks/{full_name}.js` |
| 8 | template-rule.md | rule | `src/Codex/core/rules/{name}.md` |
...
- 커맨드: `.Codex/commands/kit-create.md`
