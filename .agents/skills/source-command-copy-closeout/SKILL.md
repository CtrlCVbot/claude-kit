---
name: "source-command-copy-closeout"
description: "승인 + 잔여 리스크 기록"
---

# source-command-copy-closeout

Use this skill when the user asks to run the migrated source command `copy-closeout`.
