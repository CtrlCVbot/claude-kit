---
name: "source-command-copy-reference-refresh"
description: "기준 캡처 + evidence manifest 생성/갱신. Hybrid dev Feature는 --reference-only 모드로 경량 실행 (IMP-KIT-006)."
---

# source-command-copy-reference-refresh

Use this skill when the user asks to run the migrated source command `copy-reference-refresh`.
...
- `src/Codex/copy/rules/copy-commands.md` — "Hybrid Feature 처리" 섹션 참조
