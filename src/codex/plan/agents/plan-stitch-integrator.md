...
PRD + Wireframe + Stitch HTML을 통합하여 Feature Package 컨텍스트를 생성하는 전문 에이전트. 요구사항-화면 매핑 검증, 누락 탐지, 변환 추적을 수행합니다.
...
- Write/Edit를 사용하여 `.plans/stitch/{slug}/`에 통합 패키지 생성.
...
- Claude sibling: src/claude/plan/agents/plan-stitch-integrator.md
