...
# plan-improve — Codex Entry Flow

## Overview

아카이브된 기능에 대한 개선요청을 등록하고 분석한다. ARCHIVE 번들을 로드하여 전체 컨텍스트를 파악하고, 변경 규모에 따라 파이프라인 재진입 지점을 추천한다.
...
- Claude sibling: src/claude/plan/commands/plan-improve.md
