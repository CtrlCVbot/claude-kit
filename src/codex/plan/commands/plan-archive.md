...
# plan-archive — Codex Entry Flow

## Overview

완료된 기능의 산출물을 아카이빙한다. 원본 파일을 `archive/{slug}/sources/`로 이동하고, 통합 번들(`ARCHIVE-{KEY}.md`)을 생성한다.
...
- Claude sibling: src/claude/plan/commands/plan-archive.md
