<!-- REVIEW NEEDED: paired-review strategy (cli) — Codex runtime 검증 전 -->
<!-- kit-convert generated: 2026-04-24 -->

# copy-visual-review — Codex Entry Flow
...
- Claude sibling: `src/claude/copy/commands/copy-visual-review.md`
