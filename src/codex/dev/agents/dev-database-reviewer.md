...
쿼리 최적화, 스키마 설계, 보안, 성능을 위한 PostgreSQL 데이터베이스 전문가. SQL 작성, 마이그레이션 생성, 스키마 설계, 데이터베이스 성능 문제 해결 시 선제적으로 사용합니다.
...
- Claude sibling: src/claude/dev/agents/dev-database-reviewer.md
