 ...
 *
 * Claude peer/Codex sibling: src/codex/core/hooks/no-duplication-guard.js (동일 로직)
 ...
 * 스펙: docs/archive/kit-2.3.0-roadmap/03-p1-detailed-specs/IMP-KIT-017-no-duplication-skill.md
  *
 * Codex 등록 포맷:
 *   .codex/hooks.json: { type: "command", command: "./hooks/no-duplication-guard.js" }
 *
 ...
 *   - Windows: 현재 비활성화.
 *
 * Claude sibling: src/claude/core/hooks/no-duplication-guard.js
 */
