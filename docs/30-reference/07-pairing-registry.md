...
전체 128 entries. Claude ↔ Codex 자산 페어링 상태.
...
| `plan-revise` | command | paired | skill | command-wrapper | — | `src/claude/plan/commands/plan-revise.md` | `src/codex/plan/commands/plan-revise.md` | `src/codex/plan/skills/plan-revise-workflow/SKILL.md` |
...
| `plan-revise-workflow` | skill | codex-native-only | skill | — | — | — | `src/codex/plan/skills/plan-revise-workflow/SKILL.md` | — |
